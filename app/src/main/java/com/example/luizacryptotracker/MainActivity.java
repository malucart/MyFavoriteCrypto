            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < dataArray.length(); i++) {
                        ...
                        String image_url_crypto = image_url + dataObject.getString("symbol");



                        // extracting data from the second json
                        final int j = i;
                        JsonObjectRequest jsonObjectRequest_image = new JsonObjectRequest(Request.Method.GET, image_url_crypto, (JSONObject)null, new Response.Listener<JSONObject>() {
                            public void onResponse(JSONObject response_image) {
                                ...
                                try {
                                    ...
                                    JSONObject dataObjectImage = dataArrayImage.getJSONObject(j);
                                    String logo = dataObjectImage.getString("logo");
                                    Glide.with(MainActivity.this).load(image_url_crypto).into(ivLogo);
